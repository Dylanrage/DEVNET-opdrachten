...
print("----------1----------")
current_access_token = "Get your own token"
uri_scheme = 'https://'
...
user_email_searched = 'f.name@mail.be'
#
access_token = current_access_token 
""
...
#
payload={"title": "BRU IT Dept - Infrastructure Team"}
...
access_token = current_access_token 
room_id = NEW_SPACE_ID # Make sure you add the room ID value that was returned from the previous call you made
person_email = ''f.name2@mail.be'' # Add the email address of someone with a Webex Teams account
url = 'https://api.ciscospark.com/v1/memberships'
headers = {
    'Authorization': 'Bearer {}'.format(access_token),
    'Content-Type': 'application/json'
